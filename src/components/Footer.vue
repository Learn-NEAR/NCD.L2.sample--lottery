<template>
    <footer class="w-full bg-gray-900 px-9 py-6 z-50">
        ...
        <p class="text-gray-700 text-right">© 2021 All rights reserverd. Develop by <a href="https://t.me/NazarNyzhnyk"
                class="text-gray-400 hover:underline font-medium">Nazar Nyzhnyk</a></p>
    </footer>
</template>