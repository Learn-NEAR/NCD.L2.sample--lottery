<template>
    ...
    <div class="relative hidden md:flex flex-col items-center space-y-1">
        ...
        <!-- POPUP button -->
        <button @click="isChangeContractIdFormOpened = !isChangeContractIdFormOpened"
        ...
        <div v-if="isChangeContractIdFormOpened || apiError"
            class="absolute top-0 flex flex-col items-center z-10 bg-white rounded-xl shadow-xl pt-16 pb-8 px-5 md:px-20 w-screen md:w-500">
